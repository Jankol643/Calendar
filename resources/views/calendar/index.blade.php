...
<!-- Add a button to open the add event modal -->
<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-event-modal">Add Event</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form to add new event goes here -->
            </div>
